//
//  ViewHomeVideosViewController.h
//  Spotshot
//
...
@class ViewHomeVideoViewController;

@protocol ViewHomeVideoViewControllerDelegate <NSObject>
...
@interface ViewHomeVideosViewController : UIViewController

@property(nonatomic,weak) IBOutlet id<ViewHomeVideoViewControllerDelegate> delegate;
