//
//  SecondFeaturedViewController.m
//  Stories
//
...
@interface SecondFeaturedViewController ()
...
@implementation SecondFeaturedViewController
...
- (void)viewDidLoad {
    ...
    [self getSecondFeaturedStoryLocation];
...
-(void)getSecondFeaturedStoryLocation {
    
    
    [PFConfig getConfigInBackgroundWithBlock:^(PFConfig *config, NSError *error) {
        PFGeoPoint *secondFeaturedStoryLoc = config[@"secondFeaturedStoryLocation"];
        
        NSLog(@"Yay! The location is %@!", secondFeaturedStoryLoc);
        
        self.featuredStoryLocation = secondFeaturedStoryLoc;
...
-(void)addImagesToSlideshow: (UIImage*)storyImages {
    
    [_slideshow addImage:storyImages];
