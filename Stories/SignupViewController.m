...
- (void)viewDidLoad {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Create Account" message:@"Create a quick profile to share your videos with the world." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                                                     [UIColor colorWithRed:1 green:0.286 blue:0.204 alpha:1], NSForegroundColorAttributeName,
