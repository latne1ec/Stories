...
// Defaults
#define JWG_CIRCLE_COLOR_DEFAULT [UIColor colorWithRed:0.914 green:0.259 blue:0.259 alpha:1]
#define JWG_CIRCLE_BACKGROUND_COLOR_DEFAULT [UIColor colorWithWhite:.85f alpha:.5]
#define JWG_CIRCLE_FILL_COLOR_DEFAULT [UIColor clearColor]
#define JWG_CIRCLE_TIMER_WIDTH 1.75f
